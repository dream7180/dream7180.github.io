# foobox 7.27 (x64)，6.27 重制版 (x86), foobar2000 皮肤配置 (DUI)
...
* 从 7.26 版开始增加 foobox 6 重制版，foobox 7 专注 64 位版，foobox 6 重制版为 32 位版，其实是在 foobox 7 的基础上添加 UI Hacks 并整合了两个版本的特点，适合喜欢隐藏菜单栏状态栏 UI 的朋友。
