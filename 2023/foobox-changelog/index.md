...
{{< admonition success "2026-06-17, 8.14版" >}}
* 底部工具栏添加切换输出设备的按钮。
* 封面浏览器部分显示布局的美化。
* 修正已知 bug 及其他优化。
{{< /admonition >}}
...
* 简介面板精简一些不必要的东西.
{{< /admonition >}}
{{< admonition success "2025-12-30, 8.8版" >}}
* 修正重新打开程序有时歌词面板颜色不能恢复的问题.
* 修正改变字体播放列表面板颜色会重置的问题.
* 修正播放列表菜单里的排序反向无效的问题.
* 简介面板一些优化和美化.
* 歌词面板增加频谱 (Win7版除外)，要去除可在面板参数选项里禁用自定义布局.
{{< /admonition >}}
...
* 优化封面缓存的调用。
* foobox 设置添加封面缓存尺寸自定义。
* 组件升级：JSPlitter (4.0.3)。
{{< /admonition >}}
